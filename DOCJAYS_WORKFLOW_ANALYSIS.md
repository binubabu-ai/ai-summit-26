...
**Pros:**
- ✅ Separate from CLAUDE.md (focused purpose)
- ✅ Claude Code recognizes `skills.md` as special file
- ✅ Can define specific workflows as "skills"
- ✅ Easy to discover and maintain

**Cons:**
- ❌ Not supported by all AI tools yet
- ❌ Another file to maintain
- ❌ May overlap with CLAUDE.md

**Verdict:** 🟢 Good for Claude-specific workflows
...
- ✅ Already in use by Claude Code
- ✅ Works with existing workflow
- ✅ Committed to repo

**Cons:**
- ❌ Could make CLAUDE.md very long
- ❌ Less modular
- ❌ Harder to update incrementally

**Verdict:** 🟡 Good for simple instructions, may get unwieldy
...
**Pros:**
- ✅ Instructions co-located with content
- ✅ Auto-generated by `docjays init`
- ✅ Can be updated by CLI
- ✅ Self-documenting

**Cons:**
- ❌ Git-ignored (not in repo)
- ❌ Not discovered by AI agents automatically
- ❌ Lost when `.docjays/` is cleaned
- ❌ Requires MCP or manual reading

**Verdict:** 🟡 Good for reference, but not auto-discovered
...
**Verdict:** 🟢 Good for documentation, but needs discovery mechanism
...
**Pros:**
- ✅ Automatic with MCP integration
- ✅ Always up-to-date
...
- ❌ Doesn't help CLI/Code users

**Verdict:** 🟢 Excellent for MCP, but incomplete solution
